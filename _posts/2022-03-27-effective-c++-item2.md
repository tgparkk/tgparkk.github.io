---
layout: post
title:  "Effective c++ item2 - #define을 쓰려거든 const, enum, inline을 떠올리자"
summary: "const, enum, inline"
author: tgparkk
date: '2022-03-27 23:38:23 +0530'
category: C++
keywords: C++, constructor, define
permalink: /blog/effective-cpp-item2/
usemathjax: true
---
...
### 다시 선행 처리자에 집중합시다.
#define 지시자의 또 다른 오용 사례는 매크로 함수입니다. 함수처럼 보이지만 함수 호출 오버헤드를 일으키지 않는 매크로를 구현하는 것이지요.

잘못된 사용을 해결하는 방법은 인라인 함수에 대한 템플릿을 준비하는 것입니다.
```c++
